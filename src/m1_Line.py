...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.c = 0
        self.p1 = self.start.clone()
        self.p2 = self.end.clone()
    ...
    def line_plus(self, other_line):
        ...
        Type hints:
          ...
          :rtype: Line:
        """
        p1 = Point((other_line.start.x + self.start.x), (other_line.start.y + self.start.y))
        p2 = Point((other_line.end.x + self.end.x), (other_line.end.y + self.end.y))
        return Line(p1, p2)
        # --------------------------------------------------------------
        # DONE: 9.
        #   a. READ the above specification, including the Example.
